 ...
 * @generated
 */
public final class ZeugenEditorAdvisor extends WorkbenchAdvisor {
	/**
	...
	private static String getString(String key, Object s1) {
		return zeugen.configuration.presentation.ZeugenEditorPlugin.INSTANCE
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new ZeugenEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "zeugen.configuration.presentation.ZeugenEditorAdvisorPerspective";
	...
	/**
	 * Open action for the objects from the Zeugen model. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Zeugen model. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
