...
/**
 * This is the action bar contributor for the Zeugnis model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ZeugnisActionBarContributor extends
		EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Zeugnis model. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ZeugnisModelWizard wizard = new ZeugnisModelWizard();
	 ...
	 * @generated
	 */
	public ZeugnisActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("zeugnis-settings"));
		toolBarManager.add(new Separator("zeugnis-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ZeugenEditorPlugin.INSTANCE.getString("_UI_ZeugnisEditor_menu"),
				"zeugen.zeugnisMenuID");
