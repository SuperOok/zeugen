...
import zeugen.configuration.provider.ConfigurationItemProviderAdapterFactory;

/**
 * This is an example of a Zeugnis model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class ZeugnisEditor extends MultiPageEditorPart implements
	...
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(
			ZeugnisModelWizard.FILE_EXTENSIONS, "*.");
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(ZeugnisEditor.this, false);
			} else {
	...
	public Diagnostic analyzeResourceProblems(Resource resource,
		...
		if (!resource.getErrors().isEmpty()
			...
			BasicDiagnostic basicDiagnostic = new BasicDiagnostic(
					Diagnostic.ERROR, "zeugen.model.editor", 0, getString(
			...
			return new BasicDiagnostic(Diagnostic.ERROR, "zeugen.model.editor",
	...
	public IPropertySheetPage getPropertySheetPage() {
		PropertySheetPage propertySheetPage = new ExtendedPropertySheetPage(
			...
			public void setSelectionToViewer(List<?> selection) {
				ZeugnisEditor.this.setSelectionToViewer(selection);
				ZeugnisEditor.this.setFocus();
			}
	...
	public void doSaveAs() {
		...
		String[] files = ZeugenEditorAdvisor.openFilePathDialog(getSite()
	...
	private static String getString(String key) {
		return ZeugenEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return ZeugenEditorPlugin.INSTANCE.getString(key, new Object[] { s1 });
	}
