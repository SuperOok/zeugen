 ...
 * <em><b>Fach Typ</b></em>', and utility methods for working with them. <!--
 * end-user-doc -->
 * 
 * @see zeugen.configuration.ConfigurationPackage#getFachTyp()
 * @model
 * @generated
 */
public enum FachTyp implements Enumerator {
	/**
	 * The '<em><b>SCHULFACH</b></em>' literal object. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #SCHULFACH_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>ANDERE</b></em>' literal object. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #ANDERE_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>SCHULFACH</b></em>' literal value. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>ARBEITSGEMEINSCHAFT</b></em>' literal object
	...
	/**
	 * The '<em><b>ANDERE</b></em>' literal value. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @generated
	 */
	private static final FachTyp[] VALUES_ARRAY = new FachTyp[] { SCHULFACH,
			ARBEITSGEMEINSCHAFT, ANDERE, };

	/**
	 * A public read-only list of all the '<em><b>Fach Typ</b></em>'
	 * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static final List<FachTyp> VALUES = Collections
			.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Fach Typ</b></em>' literal with the specified literal
	...
	/**
	 * Returns the '<em><b>Fach Typ</b></em>' literal with the specified integer
	 * value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static FachTyp get(int value) {
		switch (value) {
		case SCHULFACH_VALUE:
			return SCHULFACH;
		case ARBEITSGEMEINSCHAFT_VALUE:
