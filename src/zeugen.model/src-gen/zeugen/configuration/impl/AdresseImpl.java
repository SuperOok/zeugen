 ...
 * <ul>
 * <li>{@link zeugen.configuration.impl.AdresseImpl#getStrasse <em>Strasse</em>}
 * </li>
 * <li>{@link zeugen.configuration.impl.AdresseImpl#getPostleitzahl <em>
 * Postleitzahl</em>}</li>
 * <li>{@link zeugen.configuration.impl.AdresseImpl#getStadt <em>Stadt</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AdresseImpl extends MinimalEObjectImpl.Container implements
		Adresse {
	/**
	 * The default value of the '{@link #getStrasse() <em>Strasse</em>}'
	...
	/**
	 * The cached value of the '{@link #getStrasse() <em>Strasse</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getStrasse()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getPostleitzahl()
	...
	/**
	 * The cached value of the '{@link #getPostleitzahl() <em>Postleitzahl</em>}
	 * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getPostleitzahl()
	 * @generated
	...
	public void setStrasse(String newStrasse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConfigurationPackage.ADRESSE__STRASSE, oldStrasse, strasse));
	}
	...
	public void setPostleitzahl(String newPostleitzahl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConfigurationPackage.ADRESSE__POSTLEITZAHL,
					oldPostleitzahl, postleitzahl));
	}
	...
	public void setStadt(String newStadt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConfigurationPackage.ADRESSE__STADT, oldStadt, stadt));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ConfigurationPackage.ADRESSE__STRASSE:
			return STRASSE_EDEFAULT == null ? strasse != null
					: !STRASSE_EDEFAULT.equals(strasse);
		case ConfigurationPackage.ADRESSE__POSTLEITZAHL:
			return POSTLEITZAHL_EDEFAULT == null ? postleitzahl != null
					: !POSTLEITZAHL_EDEFAULT.equals(postleitzahl);
		case ConfigurationPackage.ADRESSE__STADT:
			return STADT_EDEFAULT == null ? stadt != null : !STADT_EDEFAULT
					.equals(stadt);
		}
