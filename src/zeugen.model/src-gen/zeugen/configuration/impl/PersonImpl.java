 ...
 * <ul>
 * <li>{@link zeugen.configuration.impl.PersonImpl#getVorname <em>Vorname</em>}</li>
 * <li>{@link zeugen.configuration.impl.PersonImpl#getNachname <em>Nachname
 * </em>}</li>
 * <li>{@link zeugen.configuration.impl.PersonImpl#getGeburtstag <em>Geburtstag
 * </em>}</li>
 * <li>{@link zeugen.configuration.impl.PersonImpl#getGeburtsort <em>Geburtsort
 * </em>}</li>
 * <li>{@link zeugen.configuration.impl.PersonImpl#getName <em>Name</em>}</li>
 * <li>{@link zeugen.configuration.impl.PersonImpl#getGeschlecht <em>Geschlecht
 * </em>}</li>
 * <li>{@link zeugen.configuration.impl.PersonImpl#getNamenszusatz <em>
 * Namenszusatz</em>}</li>
 * </ul>
 * </p>
 *
...
public class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	/**
	 * The cached value of the '{@link #getVorname() <em>Vorname</em>}'
	...
	/**
	 * The default value of the '{@link #getNachname() <em>Nachname</em>}'
	...
	/**
	 * The cached value of the '{@link #getNachname() <em>Nachname</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getNachname()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getGeburtstag() <em>Geburtstag</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getGeburtstag()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getGeburtstag() <em>Geburtstag</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getGeburtstag()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getGeburtsort() <em>Geburtsort</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getGeburtsort()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getGeburtsort() <em>Geburtsort</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getGeburtsort()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getGeschlecht() <em>Geschlecht</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getGeschlecht()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getGeschlecht() <em>Geschlecht</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getGeschlecht()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getNamenszusatz()
	 * <em>Namenszusatz</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getNamenszusatz()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getNamenszusatz() <em>Namenszusatz</em>}
	 * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getNamenszusatz()
	 * @generated
	...
	public EList<String> getVorname() {
		if (vorname == null) {
			vorname = new EDataTypeUniqueEList<String>(String.class, this,
					ConfigurationPackage.PERSON__VORNAME);
		}
		return vorname;
	}
	...
	public void setNachname(String newNachname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConfigurationPackage.PERSON__NACHNAME, oldNachname,
					nachname));
	}
	...
	public void setGeburtstag(Date newGeburtstag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConfigurationPackage.PERSON__GEBURTSTAG, oldGeburtstag,
					geburtstag));
	}
	...
	public void setGeburtsort(String newGeburtsort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConfigurationPackage.PERSON__GEBURTSORT, oldGeburtsort,
					geburtsort));
	}
	...
	public void setGeschlecht(Geschlecht newGeschlecht) {
		...
		geschlecht = newGeschlecht == null ? GESCHLECHT_EDEFAULT
				: newGeschlecht;
		boolean oldGeschlechtESet = geschlechtESet;
		geschlechtESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConfigurationPackage.PERSON__GESCHLECHT, oldGeschlecht,
					geschlecht, !oldGeschlechtESet));
	}
	...
	public void unsetGeschlecht() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					ConfigurationPackage.PERSON__GESCHLECHT, oldGeschlecht,
					GESCHLECHT_EDEFAULT, oldGeschlechtESet));
	}
	...
	public void setNamenszusatz(String newNamenszusatz) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ConfigurationPackage.PERSON__NAMENSZUSATZ, oldNamenszusatz,
					namenszusatz));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConfigurationPackage.PERSON__NACHNAME:
			return NACHNAME_EDEFAULT == null ? nachname != null
					: !NACHNAME_EDEFAULT.equals(nachname);
		case ConfigurationPackage.PERSON__GEBURTSTAG:
			return GEBURTSTAG_EDEFAULT == null ? geburtstag != null
					: !GEBURTSTAG_EDEFAULT.equals(geburtstag);
		case ConfigurationPackage.PERSON__GEBURTSORT:
			return GEBURTSORT_EDEFAULT == null ? geburtsort != null
					: !GEBURTSORT_EDEFAULT.equals(geburtsort);
		case ConfigurationPackage.PERSON__NAME:
		...
		case ConfigurationPackage.PERSON__NAMENSZUSATZ:
			return NAMENSZUSATZ_EDEFAULT == null ? namenszusatz != null
					: !NAMENSZUSATZ_EDEFAULT.equals(namenszusatz);
		}
