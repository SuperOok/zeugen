...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Klassenstufe</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link configuration.impl.KlassenstufeImpl#getBezeichnung <em>Bezeichnung</em>}</li>
 *   <li>{@link configuration.impl.KlassenstufeImpl#getAnzeigename <em>Anzeigename</em>}</li>
 *   <li>{@link configuration.impl.KlassenstufeImpl#getNotentypen <em>Notentypen</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class KlassenstufeImpl extends MinimalEObjectImpl.Container implements Klassenstufe {
	/**
	...
	/**
	 * The default value of the '{@link #getAnzeigename() <em>Anzeigename</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAnzeigename()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getAnzeigename() <em>Anzeigename</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAnzeigename()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getNotentypen() <em>Notentypen</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getNotentypen()
	 * @generated
	...
	public void setBezeichnung(String newBezeichnung) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.KLASSENSTUFE__BEZEICHNUNG, oldBezeichnung, bezeichnung));
	}
	...
	public void setAnzeigename(String newAnzeigename) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.KLASSENSTUFE__ANZEIGENAME, oldAnzeigename, anzeigename));
	}
	...
	public EList<Notentyp> getNotentypen() {
		if (notentypen == null) {
			notentypen = new EObjectWithInverseResolvingEList.ManyInverse<Notentyp>(Notentyp.class, this, ConfigurationPackage.KLASSENSTUFE__NOTENTYPEN, ConfigurationPackage.NOTENTYP__KLASSENSTUFEN);
		}
		return notentypen;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConfigurationPackage.KLASSENSTUFE__NOTENTYPEN:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getNotentypen()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConfigurationPackage.KLASSENSTUFE__NOTENTYPEN:
				return ((InternalEList<?>)getNotentypen()).basicRemove(otherEnd, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ConfigurationPackage.KLASSENSTUFE__ANZEIGENAME:
				return ANZEIGENAME_EDEFAULT == null ? anzeigename != null : !ANZEIGENAME_EDEFAULT.equals(anzeigename);
			case ConfigurationPackage.KLASSENSTUFE__NOTENTYPEN:
