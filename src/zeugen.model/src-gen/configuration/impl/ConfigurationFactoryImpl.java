...
public class ConfigurationFactoryImpl extends EFactoryImpl implements ConfigurationFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ConfigurationPackage.SCHULE: return createSchule();
			case ConfigurationPackage.LEHRKRAFT: return createLehrkraft();
			case ConfigurationPackage.NOTENTYP: return createNotentyp();
			case ConfigurationPackage.KLASSENSTUFE: return createKlassenstufe();
			case ConfigurationPackage.ADRESSE: return createAdresse();
			case ConfigurationPackage.PERSON: return createPerson();
			default:
	 ...
	 * @generated
	 */
	public FachTyp createFachTypFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertFachTypToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
